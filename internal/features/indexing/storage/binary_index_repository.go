...
func init() {
	...
	gob.Register(&indexing.InvertedIndex{})
	gob.Register(&indexing.TermStats{})
	gob.Register(&indexing.DocTermStats{})
	gob.Register(&indexing.DocStats{})
}
...
func (repo *BinaryIndexRepository) SaveIndex(directoryPath string, index *indexing.InvertedIndex) error {
	if repo == nil {
...
func (repo *BinaryIndexRepository) LoadIndex(directoryPath string) (*indexing.InvertedIndex, error) {
	if repo == nil {
